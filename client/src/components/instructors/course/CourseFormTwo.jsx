  ...
  return ( 
    <div className="font-poppins w-full h-full flex  place-content-start place-items-center ">
        <div  className='w-3/5 flex flex-col place-items-start place-content-center px-3'>
            ...
            <img src={!formData.course_image ? "/instructor/image-placeholder.png" : formData.edit_mode && typeof(formData.course_image)==='string' ? details.base_url+formData.course_image : URL.createObjectURL(formData.course_image)} alt="image_preview" className="border-2 border-gray-100 p-5 my-5"/>
            <input
